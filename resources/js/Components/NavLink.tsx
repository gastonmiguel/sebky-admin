...
export default function NavLink({
    ...
    return (
        <Link
            {...props}
            className={
                'hidden items-center border-b-2 px-1 pt-1 text-sm font-medium leading-5 transition duration-150 ease-in-out focus:outline-none md:block ' +
                (active
                    ? 'border-fuchsia-400 text-gray-900 focus:border-fuchsia-700 dark:border-fuchsia-600 dark:text-gray-100'
